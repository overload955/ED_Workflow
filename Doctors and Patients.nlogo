;; maybe we can sort the patient based on their color
;; based on how urgent a patient needs treatment, we set his color
...
;; based on a probability from weights list
